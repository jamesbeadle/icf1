<script lang="ts">
    ...
    import type { RaceSummary } from "../../../../../declarations/backend/backend.did";
    ...
    <div class="flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center space-x-6">
            <div class="flex items-center space-x-2 sm:flex-col sm:items-center sm:space-x-0">
                ...
                <p class="text-lg condensed text-BrandForest sm:mt-1">#{race.raceId}</p>
            </div>
        </div>
    </div>
</button>
