...
<div class="min-h-screen bg-white">
  <BrandPanel title="Create Profile" subTitle="Join the Internet Computer Fantasy F1">
    {#if isLoading}
      ...
      <div class="mx-auto">
        ...
        <div class="flex justify-center pt-6">
          <button 
            ...
            class="brand-button px-12 py-3 text-lg {isSubmitDisabled ? 'opacity-50 cursor-not-allowed' : ''}"
          >
            Create Profile
          </button>
        </div>
